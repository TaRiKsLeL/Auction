    ...
    public partial class RegistrationLoginForm : Form
    {
        ...
        private void submitBtn_Click(object sender, EventArgs e)
        {
            ...
            if (mode) // registration
            {
                ...
                if (!flag)
                {
                    SqliteDataAccess.SaveCustomer(new CustomerModel(nameTextBox.Text, login2TextBox.Text, emailTextBox.Text, pass2TextBox.Text));
        ...
        private void loginRBtn_CheckedChanged(object sender, EventArgs e)
        {
            if (loginRBtn.Checked)
            {
                mode = false;
